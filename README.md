<div align="center">
  <img src="https://raw.githubusercontent.com/PayPol-Foundation/paypol-protocol/main/public/logo.png" alt="PayPol Logo" width="160" />
...
- [x] Multi-Tenant SaaS Gateway (Genesis Workspace Setup)
- [x] The Boardroom: Multi-Sig EIP-191 Authentication
- [x] Agentic Autopilot for Recurring Payments
- [x] Smart CSV Bulk Dispatch with Address Book Harvest
- [x] One-Click Tax & Accounting Ledger Export
- [x] Multi-Token Tempo Treasury (`AlphaUSD`, `pathUSD`, `BetaUSD`, `ThetaUSD`)
